...
std::shared_ptr<Module> makeSimpleModule() {
  ...
  m->functions.push_back(b9::FunctionDef{"add_args", i, NULL, 2, 4});
...
std::shared_ptr<Module> makeComplexModule() {
  ...
  std::vector<Instruction> i1 = {{OpCode::INT_PUSH_CONSTANT, 2},
                                 ...
                                 {OpCode::FUNCTION_RETURN},
                                 END_SECTION};
  m->functions.push_back(b9::FunctionDef{"add_args", i1, NULL, 1, 1});
  ...
  std::vector<Instruction> i2 = {{OpCode::PUSH_FROM_LOCAL, 0},
                                 ...
                                 END_SECTION};
  m->functions.push_back(b9::FunctionDef{"b9PrintString", i2, NULL, 2, 2});
  ...
  std::vector<Instruction> i3 = {{OpCode::PUSH_FROM_LOCAL, 0},
                                 ...
                                 {OpCode::FUNCTION_RETURN, 0},
                                 END_SECTION};
  m->functions.push_back(b9::FunctionDef{"b9PrintNumber", i3, NULL, 3, 3});
...
void roundTripFunctionData(FunctionDef& f) {
  ...
  auto f2 = FunctionDef{"", i2, NULL, 0, 0};
...
TEST(RoundTripSerializationTest, testFunctionData) {
  std::vector<Instruction> i1 = {{OpCode::INT_PUSH_CONSTANT, 2},
                                 ...
                                 {OpCode::FUNCTION_RETURN},
                                 END_SECTION};
  auto f1 = FunctionDef{"testName", i1, NULL, 4, 5};

  std::vector<Instruction> i2 = {};
  auto f2 = FunctionDef{"testName", i2, NULL, 4, 5};
...
TEST(RoundTripSerializationTest, testSerializeDeserialize) {
  ...
  std::vector<Instruction> i = {{OpCode::INT_PUSH_CONSTANT, 2},
                                ...
                                {OpCode::FUNCTION_RETURN},
                                END_SECTION};
  auto f = FunctionDef{"testName", i, NULL, 4, 5};
  std::vector<FunctionDef> functions;
